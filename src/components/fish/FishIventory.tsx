...
const [dTest, setDTest] = useState(Array.from({length : 25}, (v,i)=> {
  return [ 0 , 0]}));
const [dSize, setDSize] = useState(Array.from({length : 25}, (v,i)=> {
  return [ 0 , 0]}));
    ...
    <Label key={i}>
     <FishImg
      ...
      <Bubble style={{ 
        ...
        boxShadow: userPoint >= data.point ? '' : '0 -0.06em 0.1em hsl(180deg 0% 100%) inset, 0 -0.15em 0.4em hsl(0deg 90% 45%) inset, 0 0.05em 0.05em hsl(0deg 90% 45%) inset, 0.05em 0 0.1em hsl(180deg 0% 100%) inset, -0.05em 0 0.1em hsl(180deg 0% 100%) inset, 0 0.1em 0.4em hsl(0deg 90% 60%) inset' }}>   
        <BubbleA></BubbleA>
      </Bubble>
