  ...
  return (
    ...
    <WavePart4>
      <Ocean4 partF={partF}>
        ...
        <div></div>
        <p></p> 
        <Button onClick={()=>{window.scrollTo(0, 0)}}> 위로 </Button>
      </Ocean4>  
    </WavePart4>
...
const Ocean = styled.div`
  ...
  &:nth-child(2) {
    top: -175px;
  animation: ${waveAnimation} 7s cubic-bezier( 0.36, 0.45, 0.63, 0.53) -.125s infinite, ${swellAnimation}  7s ease -1.25s infinite;
  opacity: 1;
  }
  }
  &:nth-child(2) {
...
const Ocean1 = styled.div<ProfileLayerProps>`
  ...
  &:nth-child(2) {
    top: -175px;
  animation: ${waveAnimation} 3s cubic-bezier( 0.36, 0.45, 0.63, 0.53) -.125s infinite, ${swellAnimation}  7s ease -1.25s infinite;
  opacity: 1;
  }
  }
  &:nth-child(2) {
...
const Ocean2 = styled.div<PartTwo>`
  ...
  &:nth-child(2) {
    top: -175px;
  animation: ${waveAnimation} 4s cubic-bezier( 0.36, 0.45, 0.63, 0.53) -.125s infinite, ${swellAnimation}  7s ease -1.25s infinite;
  opacity: 1;
  }
  }
  &:nth-child(2) {
...
const Ocean3 = styled.div<PartThree>`
  ...
  &:nth-child(2) {
    top: -175px;
  animation: ${waveAnimation} 2s cubic-bezier( 0.36, 0.45, 0.63, 0.53) -.125s infinite, ${swellAnimation}  7s ease -1.25s infinite;
  opacity: 1;
  }
  }
  &:nth-child(2) {
...
const Ocean4 = styled.div<PartF>`
  ...
  &:nth-child(2) {
    top: -175px;
  animation: ${waveAnimation} 5s cubic-bezier( 0.36, 0.45, 0.63, 0.53) -.125s infinite, ${swellAnimation}  7s ease -1.25s infinite;
  opacity: 1;
  }
  }
  &:nth-child(2) {
